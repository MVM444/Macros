...
class ExportTaskPanel:
    ...
    def __init__(self):
        ...
        scene_layout.addLayout(self._build_actions_layout())
        ...
        config_layout = QtGui.QVBoxLayout(config_tab)
        config_layout.addWidget(QtGui.QLabel("Configuracion / Configuration\nUse el comando dedicado en la barra."))
    ...
    def _build_actions_layout(self):
        ...
        layout.addWidget(btn_add_selection)
